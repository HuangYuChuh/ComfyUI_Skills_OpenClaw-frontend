...
export const zhHantMessages = {
  ...zhMessages,
  subtitle: "解析工作流，為 Agent 構建可視化參數映射。",
  global_config: "全域配置",
  save_config: "儲存配置",
  ...
  workflow_select_all: "全選",
  workflow_clear_selection: "取消選擇",
  workflow_delete_selected: "刪除",
  workflow_select_workflow: "選擇工作流 {id}",
  ...
  back: "返回",
  wf_basic_info: "基礎資訊",
  drag_upload: "選擇工作流匯入方式",
  after_upload: "支援單個上傳、本地目錄匯入，或從 ComfyUI 批次匯入。",
  editor_import_source_label: "工作流匯入來源",
  editor_import_source_single: "單個上傳",
  editor_import_source_folder: "本地目錄",
  editor_import_source_comfyui: "從目前伺服器匯入全部工作流",
  editor_import_action_single: "選擇檔案",
  editor_import_action_folder: "選擇資料夾",
  editor_import_action_comfyui: "掃描工作流",
  editor_import_action_comfyui_scanning: "掃描中...",
  editor_upload_option_single_help: "上傳單個 workflow_api.json 開始參數映射。",
  editor_upload_option_folder_help: "匯入本地資料夾中的全部 workflow_api.json 工作流。",
  editor_upload_option_comfyui_help: "先掃描目前伺服器中已儲存的工作流，再確認是否全部匯入。",
  editor_upload_option_comfyui_help_with_server: "先掃描伺服器「{server}」中已儲存的工作流，再確認是否全部匯入。",
  editor_import_comfyui_preview_title: "確認匯入目前伺服器工作流",
  editor_import_comfyui_preview_message: "已掃描到目前伺服器中儲存的工作流。確認後，會把可匯入的工作流全部匯入到目前設定中。",
  editor_import_comfyui_preview_message_with_server: "已掃描到伺服器「{server}」中儲存的工作流。確認後，會把可匯入的工作流全部匯入到目前設定中。",
  editor_import_comfyui_preview_confirm_action: "全部匯入",
  editor_import_comfyui_preview_summary_total: "共掃描到 {count} 個",
  editor_import_comfyui_preview_summary_importable: "可匯入 {count} 個",
  editor_import_comfyui_preview_summary_renamed: "將重新命名 {count} 個",
  editor_import_comfyui_preview_summary_failed: "不可匯入 {count} 個",
  editor_import_comfyui_preview_section_importable: "待匯入工作流",
  editor_import_comfyui_preview_section_failed: "需要處理",
  editor_import_comfyui_preview_empty: "目前伺服器中沒有找到可匯入的已儲存工作流。",
  ...
  workflow_batch_delete_confirm: "確認刪除目前伺服器下已選中的 {count} 個工作流嗎？",
  workflow_batch_delete_preview: "將刪除：{items}",
  ok_del_wf: "工作流 \"{id}\" 已被刪除。",
  ok_del_wf_batch: "已刪除 {count} 個工作流。",
  ok_del_wf_batch_partial: "已刪除 {deleted} 個工作流，{missing} 個未找到。",
  err_del_wf: "刪除工作流失敗。",
  err_del_wf_batch: "批次刪除工作流失敗。",
  ...
  workflow_count_one: "共 {count} 個工作流",
  workflow_count_filtered_one: "顯示 {visible} / 共 {total} 個工作流",
  ...
  err_bulk_import_comfyui_preview: "掃描 ComfyUI 工作流失敗。",
  ...
  server_auth_label: "鑑權令牌（可選）",
  server_auth_placeholder: "Bearer your-token",
  server_auth_help: "遠端伺服器如需鑑權，填入 Authorization header 的值。",
  comfy_api_key_label: "ComfyUI API Key（可選）",
  comfy_api_key_placeholder: "comfyui-xxxxxxxx...",
  comfy_api_key_help: "用於雲端節點（Kling、Sora、Nano Banana 等）。前往 platform.comfy.org 生成。",
  comfy_api_key_help_prefix: "用於雲端節點（Kling、Sora、Nano Banana 等）。前往 ",
  comfy_api_key_help_link: "platform.comfy.org",
  comfy_api_key_help_suffix: " 生成。",
  server_test_connection: "測試連接",
  server_test_testing: "測試中…",
  server_test_ok: "連接成功",
  server_test_fail: "連接失敗",
  ...
  server_import_after_create: "儲存後從 ComfyUI 全量導入",
  ...
  editor_step_2: "基礎資訊",
  editor_step_3: "參數映射",
  editor_step_1_hint: "第 1 步：上傳 workflow_api.json 解析參數。",
  editor_step_2_hint: "第 2 步：填寫工作流基礎資訊。",
  ...
  update_available: "發現新版本（{local} → {remote}），點擊一鍵更新並重啟。",
  update_dismiss: "關閉",
  update_now: "立即更新",
  update_pulling: "正在拉取最新程式碼…",
