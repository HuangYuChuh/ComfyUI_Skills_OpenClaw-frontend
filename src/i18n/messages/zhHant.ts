...
export const zhHantMessages = {
  ...
  editor_import_source_comfyui: "掃描並匯入 ComfyUI",
  editor_import_action_single: "選擇檔案",
  editor_import_action_folder: "選擇資料夾",
  editor_import_action_comfyui: "繼續匯入",
  ...
  editor_upload_option_comfyui_help: "直接從目前選中的 ComfyUI 伺服器匯入全部可用工作流。",
  editor_upload_option_comfyui_help_with_server: "從目前伺服器「{server}」批次匯入可用工作流，開始前會先確認一次。",
  editor_import_comfyui_confirm_title: "確認匯入 ComfyUI 工作流",
  editor_import_comfyui_confirm_message: "這會立即開始從目前選中的 ComfyUI 伺服器批次匯入工作流。完成後會顯示結果報告。",
  editor_import_comfyui_confirm_message_with_server: "這會立即開始從伺服器「{server}」批次匯入工作流。完成後會顯示結果報告。",
  editor_import_comfyui_confirm_action: "開始匯入",
