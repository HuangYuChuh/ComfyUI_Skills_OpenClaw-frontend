export const zhMessages = {
  ...
  editor_import_source_comfyui: "扫描并导入 ComfyUI",
  editor_import_action_single: "选择文件",
  editor_import_action_folder: "选择文件夹",
  editor_import_action_comfyui: "继续导入",
  ...
  editor_upload_option_comfyui_help: "直接从当前选中的 ComfyUI 服务器导入全部可用工作流。",
  editor_upload_option_comfyui_help_with_server: "从当前服务器「{server}」批量导入可用工作流，开始前会先确认一次。",
  editor_import_comfyui_confirm_title: "确认导入 ComfyUI 工作流",
  editor_import_comfyui_confirm_message: "这会立即开始从当前选中的 ComfyUI 服务器批量导入工作流。导入完成后会显示结果报告。",
  editor_import_comfyui_confirm_message_with_server: "这会立即开始从服务器「{server}」批量导入工作流。导入完成后会显示结果报告。",
  editor_import_comfyui_confirm_action: "开始导入",
