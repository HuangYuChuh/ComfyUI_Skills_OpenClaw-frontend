export const zhMessages = {
  ...
  subtitle: "解析工作流，为 Agent 构建可视化参数映射。",
  lang_btn: "EN/中",
  global_config: "全局配置",
  ...
  workflow_sort_custom: "手动排序",
  workflow_sort_recent: "最近更新",
  workflow_sort_name: "名称排序",
  workflow_sort_name_asc: "工作流 ID（A-Z）",
  workflow_sort_name_desc: "工作流 ID（Z-A）",
  workflow_sort_enabled: "已启用优先",
  run_workflow_short: "运行",
  workflow_history_short: "历史",
  workflow_batch_actions: "工作流批量操作",
  workflow_selected_count: "已选择 {count} 个工作流",
  workflow_selection_mode: "管理模式",
  workflow_enter_batch_mode: "管理",
  workflow_management_active: "管理中",
  workflow_exit_batch_mode: "完成",
  workflow_select_all: "全选",
  workflow_clear_selection: "取消选择",
  workflow_delete_selected: "删除",
  workflow_select_workflow: "选择工作流 {id}",
  import_local_files: "导入本地文件",
  import_local_folder: "导入本地目录",
  import_all_from_comfyui: "从 ComfyUI 全量导入",
  bulk_import_loading: "导入中...",
  ...
  back: "返回",
  wf_basic_info: "基础信息",
  drag_upload: "选择工作流导入方式",
  after_upload: "支持单个上传、本地目录导入，或从 ComfyUI 批量导入。",
  editor_import_source_label: "工作流导入来源",
  editor_import_source_single: "单个上传",
  editor_import_source_folder: "本地目录",
  editor_import_source_comfyui: "从当前服务器导入全部工作流",
  editor_import_action_single: "选择文件",
  editor_import_action_folder: "选择文件夹",
  editor_import_action_comfyui: "扫描工作流",
  editor_import_action_comfyui_scanning: "扫描中...",
  editor_upload_option_single_help: "上传单个 workflow_api.json 开始参数映射。",
  editor_upload_option_folder_help: "导入本地文件夹中的全部 workflow_api.json 工作流。",
  editor_upload_option_comfyui_help: "先扫描当前服务器中已保存的工作流，再确认是否全部导入。",
  editor_upload_option_comfyui_help_with_server: "先扫描服务器「{server}」中已保存的工作流，再确认是否全部导入。",
  editor_import_comfyui_preview_title: "确认导入当前服务器工作流",
  editor_import_comfyui_preview_message: "已扫描到当前服务器中保存的工作流。确认后，将把可导入的工作流全部导入到当前配置中。",
  editor_import_comfyui_preview_message_with_server: "已扫描到服务器「{server}」中保存的工作流。确认后，将把可导入的工作流全部导入到当前配置中。",
  editor_import_comfyui_preview_confirm_action: "全部导入",
  editor_import_comfyui_preview_summary_total: "共扫描到 {count} 个",
  editor_import_comfyui_preview_summary_importable: "可导入 {count} 个",
  editor_import_comfyui_preview_summary_renamed: "将重命名 {count} 个",
  editor_import_comfyui_preview_summary_failed: "不可导入 {count} 个",
  editor_import_comfyui_preview_section_importable: "待导入工作流",
  editor_import_comfyui_preview_section_failed: "需要处理",
  editor_import_comfyui_preview_empty: "当前服务器中没有找到可导入的已保存工作流。",
  ...
  workflow_batch_delete_confirm: "确认删除当前服务器下已选中的 {count} 个工作流吗？",
  workflow_batch_delete_preview: "将删除：{items}",
  ok_del_wf: "工作流 \"{id}\" 已被删除。",
  ok_del_wf_batch: "已删除 {count} 个工作流。",
  ok_del_wf_batch_partial: "已删除 {deleted} 个工作流，{missing} 个未找到。",
  err_del_wf: "删除工作流失败。",
  err_del_wf_batch: "批量删除工作流失败。",
  ...
  ok_bulk_import_summary: "导入完成。新增 {created} 个，重命名 {renamed} 个，失败 {failed} 个。",
  err_bulk_import_comfyui: "从 ComfyUI 导入工作流失败。",
  err_bulk_import_comfyui_preview: "扫描 ComfyUI 工作流失败。",
  err_bulk_import_local: "导入本地工作流文件失败。",
  workflow_count: "共 {count} 个工作流",
  workflow_count_one: "共 {count} 个工作流",
  workflow_count_filtered_one: "显示 {visible} / 共 {total} 个工作流",
  ...
  export_bundle: "导出配置",
  import_bundle: "导入配置",
  bulk_import_report_title_comfyui: "ComfyUI 导入结果",
  bulk_import_report_title_local: "本地导入结果",
  bulk_import_section_created: "已新增",
  bulk_import_section_renamed: "已重命名",
  bulk_import_section_skipped: "已跳过",
  bulk_import_section_failed: "失败项",
  bulk_import_section_empty: "该分组暂无项目。",
  bulk_import_section_count: "{count} 项",
  bulk_import_summary_created: "新增：{count}",
  bulk_import_summary_renamed: "重命名：{count}",
  bulk_import_summary_skipped: "跳过：{count}",
  bulk_import_summary_failed: "失败：{count}",
  dep_check_title: "依赖检测",
  dep_check_all_ready: "所有依赖已满足，工作流可以运行。",
  dep_check_skip: "跳过",
  dep_check_install_selected: "安装选中项",
  dep_check_installing: "安装中...",
  dep_check_missing_nodes: "缺失的自定义节点",
  dep_check_unknown_nodes: "未知节点（需手动安装）",
  dep_check_missing_models: "缺失的模型文件（需手动下载）",
  dep_check_packages_count: "{count} 个节点包",
  dep_check_model_folder: "文件夹：{folder}",
  dep_check_install_results: "安装结果",
  dep_check_needs_restart: "需要重启 ComfyUI 才能生效。",
  dep_check_loading: "正在检测依赖...",
  dep_check_btn: "检测依赖",
  err_dep_check: "依赖检测失败。",
  err_dep_install: "依赖安装失败。",
  ...
  server_auth_label: "鉴权令牌（可选）",
  server_auth_placeholder: "Bearer your-token",
  server_auth_help: "远程服务器如需鉴权，填入 Authorization header 的值。",
  comfy_api_key_label: "ComfyUI API Key（可选）",
  comfy_api_key_placeholder: "comfyui-xxxxxxxx...",
  comfy_api_key_help: "用于云节点（Kling、Sora、Nano Banana 等）。前往 platform.comfy.org 生成。",
  comfy_api_key_help_prefix: "用于云节点（Kling、Sora、Nano Banana 等）。前往 ",
  comfy_api_key_help_link: "platform.comfy.org",
  comfy_api_key_help_suffix: " 生成。",
  server_test_connection: "测试连接",
  server_test_testing: "测试中…",
  server_test_ok: "连接成功",
  server_test_fail: "连接失败",
  ...
  editor_step_2: "基础信息",
  editor_step_3: "参数映射",
  editor_step_1_hint: "第 1 步：上传 workflow_api.json 解析参数。",
  editor_step_2_hint: "第 2 步：填写工作流基础信息。",
  ...
  run_workflow_title: "运行工作流 {id}",
  run_workflow_submit: "运行工作流",
  run_workflow_running: "运行中…",
  run_workflow_image_choose: "选择图片",
  run_workflow_image_uploading: "上传中…",
  run_workflow_success: "工作流「{id}」运行成功。",
  run_workflow_error: "工作流运行失败。",
  run_workflow_comfyui_error_prefix: "ComfyUI 执行出错：",
  workflow_status_running: "运行中…",
  workflow_status_success: "成功",
  workflow_status_error: "失败",
  workflow_status_view_history: "点击查看详情",
  run_workflow_no_params: "这个工作流没有暴露可运行参数。",
  run_workflow_optional_empty: "留空",
  run_workflow_boolean_true: "启用",
  run_workflow_last_result: "最近一次执行结果",
  run_workflow_status_success: "成功",
  run_workflow_status_error: "失败",
  workflow_history_title: "工作流 {id} 的执行历史",
  workflow_history_empty: "暂无执行历史。",
  workflow_history_select: "从左侧选择一条记录查看详情。",
  workflow_history_load_error: "加载执行历史失败。",
  workflow_history_delete_confirm: "确认删除这条历史记录吗？",
  workflow_history_delete_success: "历史记录已删除。",
  workflow_history_delete_error: "删除历史记录失败。",
  workflow_history_delete_entry: "删除记录",
  workflow_history_clear: "清空历史",
  workflow_history_clear_confirm: "确认清空工作流「{id}」的所有执行历史吗？",
  workflow_history_clear_success: "执行历史已清空。",
  workflow_history_clear_error: "清空执行历史失败。",
  workflow_history_status: "状态",
  workflow_history_created_at: "创建时间",
  workflow_history_finished_at: "结束时间",
  workflow_history_duration_label: "耗时",
  workflow_history_duration: "{ms} 毫秒",
  workflow_history_image_count: "{count} 张图片",
  workflow_history_preview: "产出预览",
  workflow_history_preview_empty: "这次执行没有可预览的产出图片。",
  workflow_history_overview: "执行概览",
  workflow_history_run_summary: "运行摘要",
  workflow_history_run_label: "执行 #{index}",
  workflow_history_run_id: "运行 ID",
  workflow_history_started_at: "开始时间",
  workflow_history_prompt_id: "Prompt ID",
  workflow_history_open_image: "打开原图",
  workflow_history_image_alt: "执行结果图片 {index}",
  workflow_history_image_path: "文件路径",
  workflow_history_generated_images: "产出图片",
  workflow_history_no_args: "没有可展示的参数。",
  workflow_history_resolved_args: "解析后参数",
  workflow_history_error: "错误信息",
  workflow_history_images: "结果图片",
  ...
  update_available: "发现新版本（{local} -> {remote}），点击一键更新并重启。",
  update_dismiss: "关闭",
  update_now: "立即更新",
  update_pulling: "正在拉取最新代码…",
