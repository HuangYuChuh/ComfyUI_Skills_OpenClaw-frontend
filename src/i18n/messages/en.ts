export const enMessages = {
  ...
  editor_import_source_comfyui: "Scan and Import from ComfyUI",
  editor_import_action_single: "Choose File",
  editor_import_action_folder: "Choose Folder",
  editor_import_action_comfyui: "Continue",
  ...
  editor_upload_option_comfyui_help: "Import every available workflow directly from the selected ComfyUI server.",
  editor_upload_option_comfyui_help_with_server: "Import available workflows in bulk from the current server \"{server}\". You will confirm before it starts.",
  editor_import_comfyui_confirm_title: "Confirm ComfyUI Workflow Import",
  editor_import_comfyui_confirm_message: "This will immediately start a bulk import from the currently selected ComfyUI server. A report will be shown after it finishes.",
  editor_import_comfyui_confirm_message_with_server: "This will immediately start a bulk import from server \"{server}\". A report will be shown after it finishes.",
  editor_import_comfyui_confirm_action: "Start Import",
