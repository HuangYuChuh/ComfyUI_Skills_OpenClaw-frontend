export const enMessages = {
  ...
  workflow_select_all: "Select All",
  workflow_clear_selection: "Deselect",
  workflow_delete_selected: "Delete",
  ...
  workflow_batch_delete_confirm: "Delete the selected {count} workflows on this server?",
  workflow_batch_delete_preview: "This will delete: {items}",
  ok_del_wf: "Workflow \"{id}\" deleted.",
  ok_del_wf_batch: "Deleted {count} workflows.",
  ok_del_wf_batch_partial: "Deleted {deleted} workflows, {missing} were not found.",
  err_del_wf: "Failed to delete workflow.",
  err_del_wf_batch: "Failed to delete selected workflows.",
  ...
  dep_check_all_ready: "All dependencies are satisfied. The workflow is ready to run.",
  dep_check_skip: "Skip",
  dep_check_install_selected: "Install Selected",
  dep_check_installing: "Installing...",
  dep_check_missing_nodes: "Missing Custom Nodes",
  dep_check_unknown_nodes: "Unknown Nodes (manual install required)",
  dep_check_missing_models: "Missing Models (manual download required)",
  dep_check_packages_count: "{count} packages",
  dep_check_model_folder: "Folder: {folder}",
  dep_check_install_results: "Installation Results",
  dep_check_needs_restart: "ComfyUI needs to restart for changes to take effect.",
  dep_check_loading: "Checking dependencies...",
  dep_check_btn: "Check Dependencies",
  err_dep_check: "Failed to check dependencies.",
  err_dep_install: "Failed to install dependencies.",
  ...
  comfy_api_key_label: "ComfyUI API Key (optional)",
  comfy_api_key_placeholder: "comfyui-xxxxxxxx...",
  comfy_api_key_help: "Required for cloud nodes (Kling, Sora, Nano Banana, etc). Generate at platform.comfy.org.",
  comfy_api_key_help_prefix: "Required for cloud nodes (Kling, Sora, Nano Banana, etc). Generate at ",
  ...
  run_workflow_image_choose: "Choose Image",
  run_workflow_image_uploading: "Uploading…",
  run_workflow_success: "Workflow \"{id}\" finished successfully.",
  run_workflow_error: "Workflow execution failed.",
  run_workflow_comfyui_error_prefix: "ComfyUI execution error:",
